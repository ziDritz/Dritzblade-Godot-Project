...
@export var projectile_resource : ProjectileResource = preload("res://projectile_system/Resources/auto_cannon_resource.tres")

var projectile_scene: PackedScene = preload("res://projectile_system/Scene/Projectile.tscn")
